...
data_path: str = 'QKD_Algorithms_OLD/SARG04/data/'
...
def dumpeningAnalysis(simManager: SimManager, dumpeningValues: list[float], channelLengthValues: list[float],
                      n_tests: int = 5) -> None:
    """
    ...
    plt.savefig(data_path + "dumpeningAnalysis.png", dpi=300)
    plt.show()


def baseTransformAnalysis(simManager: SimManager, baseTransformValues: list[float], channelLengthValues: list[float],
                          n_tests: int = 5) -> None:
    """
    ...
    plt.savefig(data_path + "baseTransformAnalysis.png", dpi=300)
    plt.show()


def bobsErrorEffiecencyAnalysis(simManager: SimManager, errorValues: list[float], efficiencyValues: list[float],
                                n_tests: int = 5) -> None:
    """
    ...
    plt.ylabel("Error")
    plt.savefig(data_path + "bobsErrorEffiecencyAnalysis.png", dpi=300)
    plt.show()
