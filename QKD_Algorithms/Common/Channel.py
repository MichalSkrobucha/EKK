...
class Channel:
    ...
    def __init__(self, dumpening: float, base_transform: float, logger: SimLogger):
        """
    ...
    def send(self, photons: list[Photon]) -> None:
        ...
        self.logger.log(f"Channel received {len(self.container)} photons")
    ...
    def read(self) -> list[Photon]:
        ...
        self.logger.log(f"Channel output: {len(read_container)} photons have been read")
